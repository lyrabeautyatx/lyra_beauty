...
class CouponService {
   ...
   */
  calculateDiscount(originalPrice, discountPercentage = 10) {
...
// Export both class instance and functional interface for backward compatibility
module.exports = couponService;

// Functional exports for backward compatibility with this branch
module.exports.validateCoupon = (couponCode, customerId) => couponService.validateCoupon(couponCode, customerId);
module.exports.applyDiscount = (originalPrice, discountPercentage) => couponService.calculateDiscount(originalPrice, discountPercentage);
module.exports.recordCouponUsage = (couponId, customerId, appointmentId) => couponService.recordCouponUsage(couponId, customerId, appointmentId);
module.exports.recordPartnerCommission = (partnerId, appointmentId, couponId, originalPrice) => couponService.recordPartnerCommission(partnerId, appointmentId, couponId, originalPrice);
module.exports.getCouponByCode = (code) => couponService.getCouponByCode(code);